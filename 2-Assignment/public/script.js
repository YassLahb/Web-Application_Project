...
const send_data = async function() {
    ...
    const date = DayMonth+'-'+Month+'-'+Year+'_'+Hour+'h'+Minutes+'min'+Seconds;
    data = {name:name, date:date, img_url:img_url}
    fetch('/save', {
        method: "POST",
...
function Save_Img() {
    ...
    resp.innerHTML = `Image Uploaded Successfully to the Database!`
