...
open_btn=document.getElementById("open");

if(draw_button.disabled == true)
{ 
...
function getImage(){
    ...
    console.log(dataURL);
    document.getElementById("image").innerHTML="<p>Static Downloadable Image :</p><img src='"+dataURL+"'>";
